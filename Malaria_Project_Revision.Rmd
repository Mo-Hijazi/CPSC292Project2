...
malaria1990 <- malaria1990[malaria1990$year=="1990",]
rownames(malaria1990) = seq(length=nrow(malaria1990))

malaria1991 <- malaria1991[malaria1991$year=="1991",]
rownames(malaria1991) = seq(length=nrow(malaria1991))

malaria1992 <- malaria1992[malaria1992$year=="1992",]
rownames(malaria1992) = seq(length=nrow(malaria1992))

malaria1993 <- malaria1993[malaria1993$year=="1993",]
rownames(malaria1993) = seq(length=nrow(malaria1993))

malaria1994 <- malaria1994[malaria1994$year=="1994"]
rownames(malaria1994) = seq(length=nrow(malaria1994))

malaria1995 <- malaria1995[malaria1995$year=="1995",]
rownames(malaria1995) = seq(length=nrow(malaria1995))

malaria1996 <- malaria1996[malaria1996$year=="1996",]
rownames(malaria1996) = seq(length=nrow(malaria1996))

malaria1997 <- malaria1997[malaria1997$year=="1997",]
rownames(malaria1997) = seq(length=nrow(malaria1997))

malaria1998 <- malaria1998[malaria1998$year=="1998",]
rownames(malaria1999) = seq(length=nrow(malaria1999))

malaria1999 <- malaria1999[malaria1999$year=="1999",]
rownames(malaria1999) = seq(length=nrow(malaria1999))

malaria2000 <- malaria2000[malaria2000$year=="2000",]
rownames(malaria2000) = seq(length=nrow(malaria2000))

malaria2001 <- malaria2001[malaria2001$year=="2001",]
rownames(malaria2001) = seq(length=nrow(malaria2001))

malaria2002 <- malaria2002[malaria2002$year=="2002",]
rownames(malaria2002) = seq(length=nrow(malaria2002))

malaria2003 <- malaria2003[malaria2003$year=="2003",]
rownames(malaria2003) = seq(length=nrow(malaria2003))

malaria2004 <- malaria2004[malaria2004$year=="2004",]
rownames(malaria2004) = seq(length=nrow(malaria2004))

malaria2005 <- malaria2005[malaria2005$year=="2005",]
rownames(malaria2005) = seq(length=nrow(malaria2005))

malaria2006 <- malaria2006[malaria2006$year=="2006",]
rownames(malaria2006) = seq(length=nrow(malaria2006))

malaria2007 <- malaria2007[malaria2007$year=="2007",]
rownames(malaria2007) = seq(length=nrow(malaria2007))

malaria2008 <- malaria2008[malaria2008$year=="2008",]
rownames(malaria2008) = seq(length=nrow(malaria2008))

malaria2009 <- malaria2009[malaria2009$year=="2009",]
rownames(malaria2009) = seq(length=nrow(malaria2009))

malaria2010 <- malaria2010[malaria2010$year=="2010",]
rownames(malaria2010) = seq(length=nrow(malaria2010))

malaria2011 <- malaria2011[malaria2011$year=="2011",]
rownames(malaria2011) = seq(length=nrow(malaria2011))

malaria2012 <- malaria2012[malaria2012$year=="2012",]
rownames(malaria2012) = seq(length=nrow(malaria2012))

malaria2013 <- malaria2013[malaria2013$year=="2013",]
rownames(malaria2013) = seq(length=nrow(malaria2013))

malaria2014 <- malaria2014[malaria2014$year=="2014",]
rownames(malaria2014) = seq(length=nrow(malaria2014))

malaria2015 <- malaria2015[malaria2015$year=="2015",]
rownames(malaria2015) = seq(length=nrow(malaria2015))

malaria2016 <- malaria2016[malaria2016$year=="2016",]
rownames(malaria2016) = seq(length=nrow(malaria2016))

malaria2017 <- malaria2017[malaria2017$year=="2017",]
rownames(malaria2017) = seq(length=nrow(malaria2017))
...
hi <- function(malaria.all.year){
  malaria.all.year <- rowSums(malaria1990[1:230,3:7])
}
...
*(WARNING: TAKES ALL NIGHT TO LOAD)*
```{r echo=FALSE}
...
ezplot <- function(data, yaxis, xaxis, title){
  (ggplot(data, aes(x= year, y= total.deaths, fill = year))+
  theme_dark()+
  geom_bar(stat = "identity")+ 
  theme(text = element_text(size=10),
        axis.text.x = element_text(angle=90, hjust=1))+
  scale_y_continuous(name=yaxis, breaks= seq(0,1500000, by= 100000), labels = comma, expand = c(0, 0))+
  xlab(xaxis)+
  ggtitle(title)+
  theme(legend.position = "none")+ 
  theme(plot.title = element_text(hjust = 0.5)))
...
ezplot(malaria.world,"pebis","jeeniz", "redis")
```
***UPDATE***
